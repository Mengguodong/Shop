...
namespace SFO2O.Admin.Models.Settlement
{
    ...
    public class SettlementOrderInfo
    {
        ...
        /// ProductSettlementAmount
        /// </summary>
        [DataMember(Name = "ProductSettlementAmount")]
        [Display(Name = "ProductSettlementAmount")]
        public decimal ProductSettlementAmount { get; set; }

        /// <summary>
        /// RmbProductSettlementAmount
        /// </summary>
        [DataMember(Name = "RmbProductSettlementAmount")]
        [Display(Name = "RmbProductSettlementAmount")]
        public decimal RmbProductSettlementAmount { get; set; }
        ...
        static SettlementOrderInfo()
        {
            ...
            _schema.AddField(x => x.RmbProductSettlementAmount, "RmbProductSettlementAmount");

            _schema.AddField(x => x.ProductSettlementAmount, "ProductSettlementAmount");
