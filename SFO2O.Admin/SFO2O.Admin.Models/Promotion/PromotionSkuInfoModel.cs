...
namespace SFO2O.Admin.Models.Promotion
{
    [Serializable]
    [DataContract]
    /// <summary>
    /// PromotionSkuInfoModel
    /// </summary>
    public class PromotionSkuInfoModel
    {
        ...
        /// 表中所有的成员字段
        /// </summary>
        private static readonly ObjectSchema<PromotionSkuInfoModel> _schema;
        static PromotionSkuInfoModel()
        {
            _schema = new ObjectSchema<PromotionSkuInfoModel>();
