(function () {
    var wrapHtml = '<div class="win_wrap f16" style="z-index:2147483647;">' +
        '<div class="win_top clearfix"><span class="win_title f_l mg_l20"></span><a href="javascript:void(0)" title="关闭" class="win_close f_r"></a></div>' +
        '<div class="win_cont pd_l20 pd_r20"></div>' +
        '<div class="win_btm f18 t_c pd_b20 mg_t10"><a href="javascript:void(0)" class="win_btn btn_green w135">确定</a></div>' +
        '</div>';
    var $ = jQuery;
    ...
    function ShowDialog(options) {
        ...
        var top = st + (ch - wrap.height()) / 2 - 100;
