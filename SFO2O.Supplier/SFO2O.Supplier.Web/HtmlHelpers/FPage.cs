...
namespace SFO2O.Supplier.Web
{
    public static class FPage
    {
        ...
        public static MvcHtmlString ShowFPage(this HtmlHelper Html, string urlFormat, int PageIndex, int PageSize, int recordCount, FPageMode Mode)
        {
            ...
            if (PageIndex == 1)
            {
                TempHtml.Append("<a href=\"javascript:void(0)\" class=\"pgEmpty pgFirst\">首頁</a><a href=\"javascript:void(0)\" class=\"pgEmpty\">上一頁</a>");
            }
            else
            {
                TempHtml.AppendFormat("<a href=\"{0}\" class=\"pgNext pgFirst\">首頁</a>", string.Format(urlFormat, 1))
                    .AppendFormat("<a href=\"{0}\" class=\"pgNext\">上一頁</a>", string.Format(urlFormat, PageIndex - 1));
            }
            // 数字分页
            switch (Mode)
            {
            ...
            {
                TempHtml.Append("<a href=\"javascript:void(0)\" class=\"pgEmpty\">下一頁</a><a href=\"javascript:void(0)\" class=\"pgEmpty\">末頁</a>");
            }
            else
            {
                TempHtml.AppendFormat("<a href=\"{0}\" class=\"pgNext\">下一頁</a>", string.Format(urlFormat, PageIndex + 1))
                    .AppendFormat("<a href=\"{0}\" class=\"pgNext\">末頁</a>", string.Format(urlFormat, PageCount));
            }
