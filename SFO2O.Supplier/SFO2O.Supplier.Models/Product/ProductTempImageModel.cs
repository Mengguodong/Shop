...
namespace SFO2O.Supplier.Models.Product
{
    ...
    [DataContract]
    /// <summary>
    /// ProductTempImageModel
    /// </summary>
    public class ProductTempImageModel
    {
        ...
        /// 表中所有的成员字段
        /// </summary>
        private static readonly ObjectSchema<ProductTempImageModel> _schema;
        static ProductTempImageModel()
        {
            _schema = new ObjectSchema<ProductTempImageModel>();
