...
namespace SFO2O.Supplier.Models.Product
{
    ...
    public class ProductDicsModel
    {
        ...
        /// 表中所有的成员字段
        /// </summary>
        private static readonly ObjectSchema<ProductDicsModel> _schema;
        static ProductDicsModel()
        {
            _schema = new ObjectSchema<ProductDicsModel>();
