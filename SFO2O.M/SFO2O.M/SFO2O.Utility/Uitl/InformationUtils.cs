...
namespace SFO2O.Utility
{
    ...
    {
        // 用户注册成功消息标题
        public static readonly string UserRegisterSuccTitle = "欢迎加入健康绿氧！";
        // 用户找回密码成功消息标题
        ...
        // 用户注册成功消息内容
        public static readonly string UserRegisterSuccContent = "您已成功注册成为健康绿氧一员，您将享受健康绿氧的优质服务，欢迎加入！";
        // 用户找回密码成功消息内容
        ...
        public static readonly string UserPaySuccContent_suffix = "订单付款成功，健康绿氧已收到通知，紧急备货中";
        // 订单变成交易成功消息内容前缀
        ...
        // 申诉提交成功消息内容
        public static readonly string RefundSubmitSuccContent = "您的退货申请提交成功，健康绿氧会于三个工作日内处理您的申请，请耐心等候";
        // 拼团成功消息内容
        public static readonly string TeamJoinSuccContent = "您参与的团，现已拼团成功，健康绿氧平台正在紧急备货，您坐等收货吧。";
        // 酒豆到账消息内容前缀
        public static readonly string HuoliTransferedSuccContent_Prefix = "恭喜，您收到";
        // 酒豆到账消息内容后缀
        public static readonly string HuoliTransferedSuccContent_suffix = "酒豆，可以用来购买健康绿氧的部分商品，快去用吧。";
    }
}
