...
namespace SFO2O.Utility
{
    public static class ShareUtils
    {
        ...
        // 团详情分享标题前缀-已参加用户
        public static readonly string TeamJoinSharedTitle_Joined_prefix = "我参加了爱玖网";
        // 团详情分享标题后缀-已参加用户
        ...
        // 团详情分享描述后缀-已参加用户
        public static readonly string TeamJoinSharedDescription_Joined_suffix = "人】爱玖网，贵州茅台怀桥酒厂发货，全场包邮，一起实惠一起拼！";
        // 团详情分享描述-已参加用户-人数已满
        public static readonly string TeamJoinSharedDescription_Joined_Full = "团人数已经满了";


        // 团详情分享描述-未参加用户
        public static readonly string TeamJoinSharedDescription_UnJoined = "爱玖网，贵州茅台怀桥酒厂发货，全场包邮，一起实惠一起拼！";


        // 团详情分享描述-未登录用户
        public static readonly string TeamJoinSharedDescription_UnLogined = "爱玖网，贵州茅台怀桥酒厂发货，全场包邮，一起实惠一起拼！";

        // 拼生活详情页分享描述
        public static readonly string PinLifeDetailSharedDescription = "爱玖网，贵州茅台怀桥酒厂发货，全场包邮，一起实惠一起拼！";


        // 母亲节专题标题
        public static readonly string MotherDaySpecialTitle = "母亲节特别活动 – 爱玖网购物商城";
        // 母亲节专题描述
        public static readonly string MotherDaySpecialDescription = "母亲节之际，爱玖网平台为天下的妈妈们准备了一份精美礼物，快来选择一份送给自己的妈妈吧。";
        // 母亲节专题图片
        public static readonly string MotherDaySpecialImage = "LIB/Content/Images/active/0508/shareImg.jpg?v=20160414";


        // 拼生活介绍页专题标题
        public static readonly string TeamLifeSpecialTitle = "拼生活，好闺蜜、好基友一起拼！– 爱玖网购物商城";
        // 拼生活介绍页专题描述
        ...
        // 儿童节专题标题
        public static readonly string ChildrenDaySpecialTitle = "欢度六一 礼伴成长 – 爱玖网购物商城";
        // 儿童节专题描述
