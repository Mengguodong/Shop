...
if(!window.hostname){
    ...
    window.hostname="http://www.wdnzmt9.net";   
	    ...
	    window.hostname = "http://www.wdnzmt9.cn";
		 ...
		 window.hostname="http://www.discountmassworld.com";// 正式环境
	}
}
FSH={
	//固定页脚位置
	...
	*/
	...
	menuDialog: function() {
		var diaMenuHtml = '<div class="classify_show" id="menuCon">\
												...
												<a target="_self" href="' + window.hostname + '/Product.html"><li item="nohide"><div class="pic_box"><img src="' + window.hostname + '/Content/Images/second_nav_06.png?v=201507091514"></div><p>酒列表</p></li></a>\
	...
	renderList:function (data,type){ //商品列表 // type为1时
		...
		if (data.DiscountPrice<data.MinPrice) {
		    ...
		    //a = '<div class="price"> <span class="f36">￥' + FSH.tools.showPrice(data.MinPrice) + '</span>';
		    //if (data.Coupon == 10)
            //{
		    //    a = a + '<font style="font-size: 0.59rem; color: #98CA35; ">&nbsp;&nbsp;&nbsp;赠豆</font><span class="original">' + FSH.tools.showPrice(data.DHuoli) + '</span>';
		    //}
		    //a = a + '</div>';
		}			
...
FSH.Ajax = function (obj) {
    ...
    FSH.iOSAjaxPrefix = "http://www.discountmassworld.com";
