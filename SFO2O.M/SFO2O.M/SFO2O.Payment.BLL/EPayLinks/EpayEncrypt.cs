...
namespace SFO2O.Payment.BLL.EPayLinks
{
    ...
    public class EpayEncrypt
    {
        ...
        /// <returns></returns>
        public static string Md5Encrypt(string str, string type)
        {
        ...
        public static bool Verify(string prestr, string sign)
        {
            string mysign = SHA256Encrypt(prestr).ToLower();
            if (mysign == sign)
            {
                return true;
            }
