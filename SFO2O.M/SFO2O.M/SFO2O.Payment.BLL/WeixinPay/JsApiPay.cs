...
namespace WxPayAPI
{
    public class JsApiPay
    {
	    ...
	    */
         ...
         * @失败时抛异常WxPayException
         */
        public WxPayData GetUnifiedOrderResult(string orderCode, string amount)
        {
            //LogHelper.Error("result开始了 orderCode=" + orderCode + "amount=" + amount);
            //统一下单
            WxPayData data = new WxPayData();
            data.SetValue("body", orderCode);
            data.SetValue("attach", "sf-o2o");
            ...
            LogHelper.Error("result" + result.IsSet("appid") + "*" + result.IsSet("prepay_id") + "*" + result.GetValue("prepay_id").ToString());
            if (!result.IsSet("appid") || !result.IsSet("prepay_id") || result.GetValue("prepay_id").ToString() == "")
            {
                //LogHelper.Error("UnifiedOrder response error!");
        ...
        *   "timeStamp":" 1395712654",         //时间戳4，自1970年以来的秒数     
        ...
        */
        public string GetJsApiParameters()
        {
            ...
            LogHelper.Info("Get jsApiParam : " + parameters);
            return parameters;
        }
    }
}